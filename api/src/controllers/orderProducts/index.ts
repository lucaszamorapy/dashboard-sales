...
import { createOrderProduct, deleteOrderProduct, updateOrderProduct } from "../../services/orderProducts";
...
export const deleteOrderProductController = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
